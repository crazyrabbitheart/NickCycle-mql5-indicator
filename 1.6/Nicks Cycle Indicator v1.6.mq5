...
input group "--- [4] RSI ---";
input bool soldier = false;            // Turn On Soldier
...
input bool autoSRLine = true;
input bool showTimeLine = false;
input int setDayforShowTimeLine = 5;
